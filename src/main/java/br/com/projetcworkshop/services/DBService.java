...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		cat1.getProdutos().addAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27,
						p28, p29, p30, p31, p32, p34, p35, p36, p37, p38, p39, p40, p41, p42, p43, p44, p45, p46, p47, p48, p49, p50));
		...
		produtoRepository.saveAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, 
		...
		Cliente cli1 = new Cliente(null, "Thales Lima", "thaleslima19@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("123456"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "938383964"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "anacosta@gmail.com", "25390877012", TipoCliente.PESSOA_FISICA, bCryptPasswordEncoder.encode("123456"));
		cli2.getTelefones().addAll(Arrays.asList("88553323", "938381015"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "25771012", cli2, c2);
